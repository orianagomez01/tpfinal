class Texto {
  ...
  void cargarTextos () {
    ...
    todostexto[18]="Al dia siguente Lisa Simpsons les brindo un homenaje a sus seres queridos por el tragico desenlace del incendio, debido a que homero se quemo al intentar rescatar a sus familiares.";
